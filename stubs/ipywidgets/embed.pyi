...
def dependency_state(widgets, drop_defaults=...): # -> dict[Unknown, Unknown]:
...
def embed_data(views, drop_defaults=..., state=...): # -> dict[str, dict[str, Unknown] | list[dict[str, Unknown | Any | Unicode | None] | Unknown]]:
