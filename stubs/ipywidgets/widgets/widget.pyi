...
class WidgetRegistry:
    ...
    def items(self): # -> Generator[tuple[tuple[Unknown, Unknown, Unknown, Unknown, Unknown, Unknown], Unknown], None, None]:
        ...
...
class Widget(LoggingHasTraits):
    ...
    @staticmethod
    def get_manager_state(drop_defaults=..., widgets=...): # -> dict[str, Unknown]:
